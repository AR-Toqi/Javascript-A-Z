...
// const CarCs = function(make, curSpeed){
//     this.make = make;
//     this.curSpeed = curSpeed
// };

// CarCs.prototype.accelerate = function(){
//     this.speed += 10;
//     console.log(`${this.make} is running at ${this.speed}km/h`)
// }
// CarCs.prototype.brake = function(){
//     this.speed -= 10;
//     console.log(`${this.make} is running at ${this.speed}km/h`)
// }

// const EV = function(make, curSpeed, charge){
//     CarCs.call (this, make, curSpeed)
//     this.charge = charge;
// };

// EV.prototype = Object.create(CarCs.prototype)
...
//     this.curSpeed += 20;
//     this.charge--;
//     console.log(`${this.make} is running at ${this.curSpeed}km/h, with charge of ${this.charge}`)
// }
